...
export const metadata: Metadata = {
  title: 'Dumpster Rental Hendersonville TN | Clean Site Dumpsters',
  description: 'Professional dumpster rental in Hendersonville, TN. Serving all Sumner County with same-day delivery. Residential, commercial & construction dumpsters. Call 615-717-2200.',
  keywords: 'dumpster rental hendersonville tn, hendersonville dumpster service, roll off dumpster hendersonville, sumner county dumpster rental, old hickory lake dumpster',
  alternates: {
    canonical: 'https://csdwaste.com/service-areas/hendersonville',
  },
}

export default function HendersonvilleServiceAreaPage() {
  const schema = getServiceAreaSchema('Hendersonville', '36.3048', '-86.6200')
  const breadcrumbSchema = getBreadcrumbSchema([
    { name: 'Home', url: '/' },
    { name: 'Service Areas', url: '/service-areas' },
    { name: 'Hendersonville', url: '/service-areas/hendersonville' },
  ])
  ...
  const neighborhoods = [
    ...
    'Sanders Ferry',
    'New Hope Road',
    'Vietnam Veterans Blvd',
    'Gallatin (adjacent)',
    'Goodlettsville (adjacent)',
    ...
    <>
        ...
        <Container className="relative z-10">
          <div className="max-w-4xl">
            <h1 className="font-heading font-bold uppercase tracking-wide text-5xl md:text-6xl lg:text-7xl text-white mb-4 drop-shadow-lg">
              DUMPSTER RENTAL IN HENDERSONVILLE, TN
            </h1>
            <p className="font-body text-xl md:text-2xl text-white/90 mb-8 drop-shadow-md">
              Professional Waste Removal Services Throughout Hendersonville and Sumner County
            </p>
            <AngledButton href="/contact">
              ORDER YOUR HENDERSONVILLE DUMPSTER
            </AngledButton>
          </div>
        </Container>
      </section>
        ...
        <Container>
          <nav aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 font-body text-sm text-gray-500">
              ...
              <li aria-hidden="true">/</li>
              <li className="text-gray-900 font-medium" aria-current="page">Hendersonville</li>
            </ol>
          </nav>
        </Container>
      </div>
        ...
        <Container>
          <div className="max-w-[900px] mx-auto text-center">
            <p className="font-body text-base md:text-lg text-gray-700 leading-relaxed">
              Clean Site Dumpsters proudly serves Hendersonville, Tennessee and all of Sumner County with reliable dumpster rental services for residential, commercial, and construction projects. As a locally owned Middle Tennessee company, we understand the unique needs of Hendersonville homeowners, businesses, and contractors.
            </p>
          </div>
        </Container>
      </section>
          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="font-body text-base md:text-lg text-gray-700 leading-relaxed max-w-[900px] mx-auto">
                We provide fast, reliable dumpster delivery throughout Hendersonville and the greater Sumner County area. Whether you&apos;re near Old Hickory Lake, in the heart of Hendersonville, or any surrounding community, Clean Site Dumpsters has you covered with same-day and next-day service.
              </p>
            </div>

            <h3 className="font-heading font-semibold uppercase tracking-wide text-xl md:text-2xl text-black mb-8 text-center">
              HENDERSONVILLE AREAS WE SERVE:
            </h3>
            ...
            <p className="font-body text-base text-gray-600 text-center italic">
              Don&apos;t see your area? Give us a call - we serve all of Sumner County!
            </p>
          </div>
        </Container>
      </section>
      ...
      <section className="py-16 md:py-20">
        <Container>
          <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-12 text-center">
            WHY HENDERSONVILLE TRUSTS CLEAN SITE DUMPSTERS
          </h2>
        ...
        <Container>
          <div className="text-center mb-12">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-6">
              DUMPSTER SERVICES IN HENDERSONVILLE
            </h2>
            <p className="font-body text-base md:text-lg text-gray-700 leading-relaxed max-w-[900px] mx-auto">
              From lakefront property cleanouts to new construction projects, Clean Site Dumpsters provides the right solution for every Hendersonville waste removal need.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20">
        <Container>
          <div className="max-w-[900px] mx-auto text-center">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-6">
              HENDERSONVILLE DUMPSTER RENTAL PRICING
            </h2>
        ...
        <Container>
          <div className="max-w-[900px] mx-auto">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-8 text-center">
              HENDERSONVILLE WASTE DISPOSAL REGULATIONS
            </h2>
            <p className="font-body text-base md:text-lg text-gray-700 leading-relaxed mb-6 text-center">
              Clean Site Dumpsters handles all disposal in accordance with Hendersonville and Sumner County regulations. We work with local facilities to ensure proper waste management and recycling when applicable.
            </p>
            <div className="bg-white rounded-lg p-6 border-l-4 border-[#D32F2F]">
              <p className="font-body text-base text-gray-700 leading-relaxed">
                <strong className="font-semibold">Permit Information:</strong> For most residential driveways in Hendersonville, no permit is required. If you need to place a dumpster on a public street, you may need a permit from the City of Hendersonville. We&apos;re happy to guide you through the process.
              </p>
            </div>
          </div>
        </Container>
        ...
        <Container>
          <div className="text-center text-white max-w-[900px] mx-auto">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl mb-6">
              READY TO ORDER YOUR HENDERSONVILLE DUMPSTER?
            </h2>
            <p className="font-body text-base md:text-lg text-white/90 leading-relaxed mb-8">
              Fast, reliable dumpster rental service throughout Hendersonville and Sumner County. Order online now or call us to discuss your project.
            </p>
