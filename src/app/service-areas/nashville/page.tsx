...
export const metadata: Metadata = {
  ...
  description: 'Professional dumpster rental in Nashville, TN. Serving all Nashville neighborhoods with same-day delivery. Residential, commercial & construction dumpsters. Call 615-717-2200.',
  keywords: 'dumpster rental nashville, nashville dumpster service, roll off dumpster nashville tn, davidson county dumpster rental, nashville waste removal',
  alternates: {
    canonical: 'https://csdwaste.com/service-areas/nashville',
  },
}

export default function NashvilleServiceAreaPage() {
  const schema = getServiceAreaSchema('Nashville', '36.1627', '-86.7816')
  const breadcrumbSchema = getBreadcrumbSchema([
    { name: 'Home', url: '/' },
    { name: 'Service Areas', url: '/service-areas' },
    { name: 'Nashville', url: '/service-areas/nashville' },
  ])
  ...
  const whyChooseUs = [
    {
      icon: 'location',
      title: 'LOCAL COMPANY',
      description: 'Nashville owned and operated since 2021',
    },
    {
      icon: 'clock',
      title: 'FAST DELIVERY',
    ...
    <>
        ...
        <Container className="relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="font-body text-xl md:text-2xl text-white/90 mb-8 drop-shadow-md">
              Professional Waste Removal Services Throughout Nashville and Surrounding Areas
            </p>
            <AngledButton href="/contact">
              ORDER YOUR NASHVILLE DUMPSTER
            </AngledButton>
          </div>
        </Container>
      </section>
        ...
        <Container>
          <nav aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 font-body text-sm text-gray-500">
              ...
              <li aria-hidden="true">/</li>
              <li className="text-gray-900 font-medium" aria-current="page">Nashville</li>
            </ol>
          </nav>
        </Container>
      </div>
        ...
        <Container>
          <div className="max-w-[900px] mx-auto text-center">
            <p className="font-body text-base md:text-lg text-gray-700 leading-relaxed">
              Clean Site Dumpsters proudly serves Nashville, Tennessee with reliable dumpster rental services for residential, commercial, and construction projects. As a locally owned and operated company, we understand the unique needs of Nashville homeowners, businesses, and contractors.
            </p>
          </div>
        </Container>
      </section>
          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="font-body text-base md:text-lg text-gray-700 leading-relaxed max-w-[900px] mx-auto">
                We provide fast, reliable dumpster delivery throughout Nashville and the greater Davidson County area. Whether you&apos;re in downtown Nashville, the Gulch, East Nashville, or any surrounding neighborhood, Clean Site Dumpsters has you covered.
              </p>
            </div>

            <h3 className="font-heading font-semibold uppercase tracking-wide text-xl md:text-2xl text-black mb-8 text-center">
              NASHVILLE AREAS WE SERVE:
            </h3>
            ...
            <p className="font-body text-base text-gray-600 text-center italic">
              Don&apos;t see your neighborhood? Give us a call - we likely serve your area!
            </p>
          </div>
        </Container>
      </section>
      ...
      <section className="py-16 md:py-20">
        <Container>
          <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-12 text-center">
            WHY NASHVILLE TRUSTS CLEAN SITE DUMPSTERS
          </h2>
        ...
        <Container>
          <div className="text-center mb-12">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-6">
              DUMPSTER SERVICES IN NASHVILLE
            </h2>
            <p className="font-body text-base md:text-lg text-gray-700 leading-relaxed max-w-[900px] mx-auto">
              From spring cleaning to major construction projects, Clean Site Dumpsters provides the right solution for every Nashville waste removal need.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20">
        <Container>
          <div className="max-w-[900px] mx-auto text-center">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-6">
              NASHVILLE DUMPSTER RENTAL PRICING
            </h2>
        ...
        <Container>
          <div className="max-w-[900px] mx-auto">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-8 text-center">
              NASHVILLE WASTE DISPOSAL REGULATIONS
            </h2>
            <p className="font-body text-base md:text-lg text-gray-700 leading-relaxed mb-6 text-center">
              Clean Site Dumpsters handles all disposal in accordance with Nashville and Davidson County regulations. We work with local facilities to ensure proper waste management and recycling when applicable.
            </p>
            <div className="bg-white rounded-lg p-6 border-l-4 border-[#D32F2F]">
              <p className="font-body text-base text-gray-700 leading-relaxed">
                <strong className="font-semibold">Permit Information:</strong> For most residential driveways, no permit is required. If you need to place a dumpster on a public street, you may need a permit from Metro Nashville. We&apos;re happy to guide you through the process.
              </p>
            </div>
          </div>
        </Container>
        ...
        <Container>
          <div className="text-center text-white max-w-[900px] mx-auto">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl mb-6">
              READY TO ORDER YOUR NASHVILLE DUMPSTER?
            </h2>
            <p className="font-body text-base md:text-lg text-white/90 leading-relaxed mb-8">
              Fast, reliable dumpster rental service throughout Nashville and Davidson County. Order online now or call us to discuss your project.
            </p>
