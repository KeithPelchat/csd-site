...
export const metadata: Metadata = {
  title: 'Dumpster Rental Mount Juliet TN | Clean Site Dumpsters',
  description: 'Professional dumpster rental in Mount Juliet, TN. Serving all Wilson County with same-day delivery. Residential, commercial & construction dumpsters. Call 615-717-2200.',
  keywords: 'dumpster rental mount juliet tn, mount juliet dumpster service, roll off dumpster mount juliet, wilson county dumpster rental, providence dumpster',
  alternates: {
    canonical: 'https://csdwaste.com/service-areas/mount-juliet',
  },
}

export default function MountJulietServiceAreaPage() {
  const schema = getServiceAreaSchema('Mount Juliet', '36.2000', '-86.5186')
  const breadcrumbSchema = getBreadcrumbSchema([
    { name: 'Home', url: '/' },
    { name: 'Service Areas', url: '/service-areas' },
    { name: 'Mount Juliet', url: '/service-areas/mount-juliet' },
  ])

  const neighborhoods = [
    'Downtown Mount Juliet',
    'Providence',
    'Beckwith Crossing',
    'Sunset',
    'Curd Road',
    ...
    <>
        ...
        <Container className="relative z-10">
          <div className="max-w-4xl">
            <h1 className="font-heading font-bold uppercase tracking-wide text-5xl md:text-6xl lg:text-7xl text-white mb-4 drop-shadow-lg">
              DUMPSTER RENTAL IN MOUNT JULIET, TN
            </h1>
            <p className="font-body text-xl md:text-2xl text-white/90 mb-8 drop-shadow-md">
              Professional Waste Removal Services Throughout Mount Juliet and Wilson County
            </p>
            <AngledButton href="/contact">
              ORDER YOUR MOUNT JULIET DUMPSTER
            </AngledButton>
          </div>
        </Container>
        ...
        <Container>
          <nav aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 font-body text-sm text-gray-500">
              ...
              <li aria-hidden="true">/</li>
              <li className="text-gray-900 font-medium" aria-current="page">Mount Juliet</li>
            </ol>
          </nav>
        </Container>
      </div>
          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-12">
              <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-8">
                SERVING MOUNT JULIET AND WILSON COUNTY
              </h2>
              <p className="font-body text-base md:text-lg text-gray-700 leading-relaxed max-w-[900px] mx-auto">
                We provide fast, reliable dumpster delivery throughout Mount Juliet and the greater Wilson County area. Whether you&apos;re in Providence, near the new developments, or any surrounding community, Clean Site Dumpsters has you covered with same-day and next-day service.
              </p>
            </div>
            ...
            <p className="font-body text-base text-gray-600 text-center italic">
              Don&apos;t see your neighborhood? Give us a call - we serve all of Wilson County!
            </p>
          </div>
        </Container>
      </section>
      ...
      <section className="py-16 md:py-20">
        <Container>
          <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-12 text-center">
            WHY MOUNT JULIET TRUSTS CLEAN SITE DUMPSTERS
          </h2>
        ...
        <Container>
          <div className="text-center mb-12">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-6">
              DUMPSTER SERVICES IN MOUNT JULIET
            </h2>
            <p className="font-body text-base md:text-lg text-gray-700 leading-relaxed max-w-[900px] mx-auto">
              From growing residential communities to expanding commercial developments, Clean Site Dumpsters provides the right solution for every Mount Juliet waste removal need.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20">
        <Container>
          <div className="max-w-[900px] mx-auto text-center">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-6">
              MOUNT JULIET DUMPSTER RENTAL PRICING
            </h2>
        ...
        <Container>
          <div className="max-w-[900px] mx-auto">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl text-black mb-8 text-center">
              MOUNT JULIET WASTE DISPOSAL REGULATIONS
            </h2>
            <p className="font-body text-base md:text-lg text-gray-700 leading-relaxed mb-6 text-center">
              Clean Site Dumpsters handles all disposal in accordance with Mount Juliet and Wilson County regulations. We work with local facilities to ensure proper waste management and recycling when applicable.
            </p>
            <div className="bg-white rounded-lg p-6 border-l-4 border-[#D32F2F]">
              <p className="font-body text-base text-gray-700 leading-relaxed">
                <strong className="font-semibold">Permit Information:</strong> For most residential driveways in Mount Juliet, no permit is required. If you need to place a dumpster on a public street, you may need a permit from the City of Mount Juliet. We&apos;re happy to guide you through the process.
              </p>
            </div>
          </div>
        </Container>
        ...
        <Container>
          <div className="text-center text-white max-w-[900px] mx-auto">
            <h2 className="font-heading font-bold uppercase tracking-wide text-3xl md:text-4xl lg:text-5xl mb-6">
              READY TO ORDER YOUR MOUNT JULIET DUMPSTER?
            </h2>
            <p className="font-body text-base md:text-lg text-white/90 leading-relaxed mb-8">
              Fast, reliable dumpster rental service throughout Mount Juliet and Wilson County. Order online now or call us to discuss your project.
            </p>
