          ...
          <div className="hidden lg:flex items-center gap-8">
            {navigation.main.map((item) => (
              ...
              >
                <Link
                  href={item.href}
                  className="font-heading text-white hover:text-[#D32F2F] transition-colors font-medium uppercase tracking-wide py-2"
                >
                  {item.name}
                  {item.submenu && (
                    <svg
            ...
            <div className="flex flex-col gap-2">
              {navigation.main.map((item) => (
                <div key={item.name}>
                  <Link
                    href={item.href}
                    className="font-heading block py-2 text-white hover:text-[#D32F2F] transition-colors font-medium uppercase tracking-wide"
              ...
              <a
                href={`tel:${siteConfig.business.phone.replace(/\./g, '')}`}
                className="font-heading flex items-center gap-2 py-2 text-[#D32F2F] font-semibold tracking-wide"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
